      ...
      <div className="listingshow__footer-container">
        <div className="listingshow__footer-content">
          ...
          <p className="listingshow__footer-text">
            &copy; 2019 Airbnb, Inc. Built with <span>&hearts;</span> by <a className="listingshow__footer-link" target="_blank" href="https://www.linkedin.com/in/kenneth-choi-42502a35/">Kenny Choi</a>
          </p>
        </div>
      </div>
    );
